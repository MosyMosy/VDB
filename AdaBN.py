...
def main(args):
    ...
    elif args.model == 'resnet18_s':
        backbone = models.resnet18_s()
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='STARTUP')
    parser.add_argument('--dir', type=str, default='./logs/temp',
    ...
    parser.add_argument('--base_dictionary', default='logs/STARTUP/EuroSAT/checkpoint_best.pkl', help='base model to addapt')
